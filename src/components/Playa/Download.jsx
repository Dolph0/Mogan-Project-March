...
export default function Download() {
  return (
    <section className="relative flex flex-col w-full lg:min-h-screen">
      <div className="relative bg-white w-full px-8 sm:py-0 pt-[34px] sm:pt-[86px]   pb-[96px] sm:pb-[171px]">
        <div className="max-w-screen-xl mx-auto space-y-4">
          ...
          <p className="font-light text-sm leading-[21px] text-justify max-w-[329px] sm:max-w-[551px]">
            A lo largo de nuestros 16 kilómetros de costa, te aguardan un total
            de 22 playas, cada una con su propio atractivo especial. Ya sea que
            busques tranquilidad o facilidad de acceso, arena dorada o de origen
            volcánico, aguas serenas y cristalinas, aquí encontrarás una
            diversidad de opciones para explorar.
            <br /> <br />
            Explora la esencia única de cada una, descubre los servicios que
            tienen para ofrecer y cómo llegar a ellas.
          </p>
        ...
        <Image
          ...
          src={"/playa/wave.svg"}
          layout="cover"
          className="hidden sm:block absolute -bottom-4 object-cover object-top left-0 w-full h-[140px]"
          width={1440}
          height={327}
        />
        <Image
      ...
      <div className="w-full  bg-[#004870] px-8 pb-[70px] sm:pb-[174px] pt-[46px] sm:pt-[35px] gap-[30px] sm:gap-[52px]">
        <div className="max-w-screen-xl mx-auto space-y-5">
          ...
          <button className="border-solid border-[2px] border-white bg-transparent py-3 rounded-[5px] w-[222px]">
            <span className="font-bold text-center text-[14px] leading-[21px] text-white mx-auto">
              Reserva aquí
            </span>
          </button>
        </div>
      ...
      <Image
        ...
        className="hidden md:block absolute top-[-8px] right-0   h-[327px]"
        width={181}
        height={327}
      />
      <Image
        alt="Playa"
        src={"/playa/phone.png"}
        className="hidden md:block absolute bottom-0 right-0 w-[400px] xl:w-[600px] object-contain 2xl:w-[700px] "
        width={718}
        height={1124}
      />
    </section>
