...
export const datas  = [
  {
    id: 1,
    title: "Procedimiento de selección de personal lista de reserva SOCORRISTA",
    details: ` * En el caso de que no se presenten solicitudes por personas que
              ...
              discapacidad.`,
    img_url:
      "https://www.gestmogan.com/wp-content/uploads/2021/11/ofertadeempleo-300x157.jpeg",
    counter: {
      target_date: "2024-07-15T23:59:59",
      title:
        "Plazo para presentación de documentación hasta el día 08 de Julio de 2.024",
    },
    accordions: [
      {
        id: 1,
        title:
          "Publicación  lista provisional el los días siguientes al ultimo dia de plazo",
        details: `  `,
      },
      {
        id: 2,
        title:
          "plazo serán 5 diás a contar desde la fecha de publicación de la lista provisional",
        details: `  – Sino se subsana en el tiempo establecido no se tendrá en cuenta la nota del examen.`,
      },
      {
        id: 3,
        title: `Publicación lista definitiva "No se concreta"`,
        details: `    `,
      },
      {
        id: 4,
        title: "Prueba escrita y entrevista personal",
        details: ` 1º- Establecer el lugar donde se realizará la PRUEBA ESCRITA
